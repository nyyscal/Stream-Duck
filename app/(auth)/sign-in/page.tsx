      ...
      <aside className='testimonial'>
        ...
        <div className='description'>
          <section>
            ...
            <p>SnapCast makes screen recording easy. From quick walkthroughs to full persentations, it&apos;s fast, smooth, and shareable in seconds.</p>
            <article>
              <Image src="/assets/images/jason.png" alt='jason' width={64} height={64} className='rounded-full'/>
              <div>
                <h2>Jason Mahrez</h2>
                <p>Product Designer, NovaLegacy</p>
              </div>
            </article>
          </section>
        </div>
